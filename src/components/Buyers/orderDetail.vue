      ...
      <ul>
        <li class="car-item" v-for="(item,index) in good_list">
          <div class="car-item-content">
            ...
            <div class="cat-desc">
              数量:<span style="color:#999">【申请{{item.count}}】</span><span style="color:red">【已发{{item.send_count}}】</span><span style="color:#00A0EA">【已收{{item.confirm_count}}】</span>
            </div>
            <div class="num">
