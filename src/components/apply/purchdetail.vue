      ...
      <ul>
        <li class="car-item" v-for="(item,index) in good_list">
          <div class="car-item-content">
            ...
            <div class="cat-desc">
              数量:<span style="color:#999">【申请{{item.count}}】</span><span style="color:red">【批准{{item.agree_count}}】</span>
            </div>
            <div class="num">
...
<script scoped>
  ...
  export default {
    ...
    methods: {
      //请求接口方法
      getlist(){
        axios.get(urlPublic.publicUrl + 'apply/' + this.$route.query.id + '/goods/list/page/1').then(response => {
